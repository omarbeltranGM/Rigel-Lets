...
window.onload = function () {
	...
	background.src = "resources/sentinel-layout/images/images.jpeg";
...
function convertCanvasToImage(canvas) {
	...
	image.src = canvas.toDataURL("image/jpeg");
        document.getElementById('form:foto').value = image.src;
	document.getElementById("imag").src = image.src;
}