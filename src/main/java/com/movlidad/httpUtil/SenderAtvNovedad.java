 ...
 * @author solucionesit
 */
public class SenderAtvNovedad {

    private static JSONObject objeto;
    private static JSONObject data;

    private SenderAtvNovedad() {
    }
    ...
    public static boolean send(JSONObject objeto, String postUrl) {
        try {
            ...
            StringEntity postingString = new StringEntity(objeto.toString());//gson.tojson() converts your pojo to json
