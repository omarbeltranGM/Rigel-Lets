 ...
 * @author cesar
 */
@Named(value = "sstAutorizacionPublicoJSF")
@ViewScoped
public class SstAutorizacionPublicoJSF implements Serializable {
    ...
    public SstAutorizacionPublicoJSF() {
    }
    ...
    public void guardar() {
        ...
        if (isEditing) {
            if (validacion == null) {
                ...
                if (sstAutorizacion.getVisitaAprobada() == 1) {
                    if (sstAutorizacion.getIngreso() == 0 || sstAutorizacion.getSalio() == 0) {
                        sstAutorizacion.setVisitaAprobada(0);

                        sstEsMatEqui = sstAutorizacion.getIdSstEsMatEqui();
                ...
                if (flagMateriales) {
                    ...
                    sstEsMatEqui.setUsername(aPIJSF.getSstEmpresa().getUsrNombre());
                    ...
                    for (SstEsMatEquiDet detalle : lstEsMatEquiDet) {
                        ...
                        detalle.setUsername(aPIJSF.getSstEmpresa().getUsrNombre());
            ...
            if (validacion == null) {
                ...
                sstAutorizacion.setUsername(aPIJSF.getSstEmpresa().getUsrNombre());
    ...
    public void prepareListVisitantes() {
        lstEmpresaVisitantes = empresaVisitanteEjb.findAllAprobadosByEmpresa(aPIJSF.getSstEmpresa().getIdSstEmpresa());
     ...
     * registro/modificación de una autorización
     *
     * @param event
     */
    public void onVisitanteChosen(SelectEvent event) {
    ...
    public void nuevoDetalle() {
        ...
        lstMatEquiMarcas = matEquiMarcaEjb.findAllEstadoReg(aPIJSF.getSstEmpresa().getIdSstEmpresa());
        lstMatEquipos = matEquiEjb.findAllEstadoReg(aPIJSF.getSstEmpresa().getIdSstEmpresa());
        i_sstMatEqui = null;
    ...
    public void guardarDetalleEnLista() {
        if (isEditingDetalle) {
            ...
            sstMatEqui.setUsername(aPIJSF.getSstEmpresa().getUsrNombre());
            sstMatEqui.setIdSstEmpresa(aPIJSF.getSstEmpresa());
    ...
    public List<SstAutorizacion> getLstAutorizaciones() {
        lstAutorizaciones = autorizacionEjb.findBySstEmpresa(aPIJSF.getSstEmpresa().getIdSstEmpresa());
