 ...
 */
@Named(value = "lucroCesanteBean")
@ViewScoped
public class LucroCesanteBean implements Serializable {
    ...
    private List<ReporteLucroCesante> lista;
    ...
    public void consultar() {
        ...
        lista = accidenteEjb.findByRangoFechasAndUf(fecha, fechaFin,
    ...
    public List<ReporteLucroCesante> getLista() {
        return lista;
    }

    public void setLista(List<ReporteLucroCesante> lista) {
        this.lista = lista;
    }
