...
public class MapGeoBean implements Serializable {
    ...
    public void abrirMapaTodosvehiculos() {
        ...
        MovilidadUtil.openModal("map_geo_all_wv");
    ...
    public boolean validarRol() {
        for (GrantedAuthority auth : user.getAuthorities()) {
            if (SingletonConfigEmpresa.getMapConfiMapEmpresa()
                    .get(ConstantsUtil.ROLE_VIEW_PARRILLA_MAPA)
                    .contains(auth.getAuthority())) {
//                if (auth.getAuthority().equals("ROLE_TC")
//                        || auth.getAuthority().equals("ROLE_LIQ")
...
//                }
    ...
    public void openMapGeo(String codVehiculo) {
        ...
        MovilidadUtil.openModal("map_geo_wv");
    ...
    public void openMapGeoVehEspecifico(PrgTc prgtc) {
        ...
        MovilidadUtil.openModal("map_geo_rec_veh_esp_wv");
