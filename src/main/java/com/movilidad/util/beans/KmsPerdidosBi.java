 ...
 * @func Servicios Perdidos (Bi) para informe de control.
 */
@XmlRootElement
public class KmsPerdidosBi implements Serializable {
    ...
    public KmsPerdidosBi(long count_operaciones, BigDecimal operaciones, long count_mtto, BigDecimal mtto, long count_otros, BigDecimal otros) {
