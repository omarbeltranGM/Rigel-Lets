 ...
 */
@XmlRootElement
public class ConsolidadoLiquidacion implements Serializable {
    ...
    public ConsolidadoLiquidacion(Date fecha, String identificacion, String nombre, BigDecimal diurnas, BigDecimal nocturnas, BigDecimal extra_diurna, BigDecimal festivo_diurno, BigDecimal festivo_nocturno, BigDecimal festivo_extra_diurno, BigDecimal festivo_extra_nocturno, BigDecimal extra_nocturna, BigDecimal dominical_comp_diurnas, BigDecimal dominical_comp_nocturnas, BigDecimal dominical_comp_diurna_extra, BigDecimal dominical_comp_nocturna_extra) {
        this.fecha = fecha;
