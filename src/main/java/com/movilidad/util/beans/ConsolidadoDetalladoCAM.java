 ...
 */
@XmlRootElement
public class ConsolidadoDetalladoCAM implements Serializable {
    ...
    public ConsolidadoDetalladoCAM(Date fecha, String identificacion, String nombre, String cargo, BigDecimal salario, BigDecimal diurnas, BigDecimal nocturnas, BigDecimal extra_diurna, BigDecimal festivo_diurno, BigDecimal festivo_nocturno, BigDecimal festivo_extra_diurno, BigDecimal festivo_extra_nocturno, BigDecimal extra_nocturna, BigDecimal dominical_comp_diurnas, BigDecimal dominical_comp_nocturnas, BigDecimal dominical_comp_diurna_extra, BigDecimal dominical_comp_nocturna_extra) {
        this.fecha = fecha;
